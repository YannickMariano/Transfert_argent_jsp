...
<body>
    ...
    <main class="container mt-4">
        ...
        <div class="d-flex justify-content-between mb-3">
            <a href="<%=request.getContextPath() %>/new_frais" class="btn btn-success">
                <i class="fas fa-plus-circle"></i> Ajouter un nouveau Frais
            </a>
        </div>
                ...
                <tbody>
                    <c:forEach var="frais" items="${listFrais}">
                        <tr>
                            ...
                            <td>
                                <a href="edit_frais?id_frais=<c:out value='${frais.id_frais}'/>" class="btn btn-primary btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="delete_frais?id_frais=<c:out value='${frais.id_frais}'/>" class="btn btn-danger btn-sm">
